                ...
                {{-- <div class="secondary-nav">
                    <div class="breadcrumbs-container" data-page-heading="Analytics">
                        <header class="header navbar navbar-expand-sm">
                                ...
                                <div class="page-header">
                                    ...
                                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Analytics
                                            </li>
                                        </ol>
                                    </nav>
                            ...
                            <ul class="flex-row navbar-nav ms-auto breadcrumb-action-dropdown">
                            ...
                            <div class="widget-content">
                                <div class="account-box">
                                    ...
                                    <div class="info-box">
                                        <div class="icon">
                                            <span>
                                                <img src="{{ asset('dashboard/assets/src/assets/img/money-bag.png') }}"
                                                    alt="money-bag">
                                            </span>
                                        </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-activity-five">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="mx-auto mt-container">
