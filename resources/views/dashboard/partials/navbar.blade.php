...
<div class="header-container container-xxl heder-edit">
    ...
    <header class="header navbar navbar-expand-sm expand-header ">
        ...
        {{-- <ul class="flex-row text-center navbar-item theme-brand">
            <li class="nav-item theme-logo">
                <a href="index.html">
                    <img src="{{ asset('dashboard/assets/img/logo.svg') }}" class="navbar-logo" alt="logo">
                </a>
            </li>
        ...
        <ul class="flex-row navbar-item ms-lg-auto ms-0 action-area">
                ...
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown"
                    ...
                    <div class="avatar-container">
                        <div class="avatar avatar-sm avatar-indicators avatar-online">
                            <img alt="avatar" src="{{ asset('dashboard/assets/src/assets/img/profile-30.png') }}" class="rounded-circle">
                        </div>
                    </div>
                </a>
