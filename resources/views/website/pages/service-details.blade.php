...
<style>
    ...
    <!-- card-details  -->
    {{-- <div class="img-cover" id="img-cover" style="margin-top: 40px; background-image :url({{ asset('storage/' . $settings->hero_image) }})">
        <div class="container">
            <div class="row ">
                <p
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title"
                                    ...
                                    {{$item->name}}</h5>
                                <p class="card-text"
                                    style="color: rgba(71, 85, 105, 1); font-weight: 300; font-size: 18px; line-height: 28.8px; text-align: right; ">{{$item->description}}
                                </p>
...
<div class="container items-center pb-5 mt-5 boxess d-flex justify-content-center">
        <div class="asdkaklii">
    ...
    <div class="">
        <div class="container">
            <div class="container row" style="margin-top: 3%; padding-bottom: 5%;">

                <div class="col" style="margin-bottom: 25px;">
                    <div class="mb-3 card" style="border: none; margin: 5px;">
                        <div class="asdiii"><img src="{{asset('assets/img/ground-form.png')}}" class="card-img-top" alt="..."
                                style="width: 90%;"></div>
                        <div class="card-body">

                            <p class="card-text"
                                style="color: rgba(71, 85, 105, 1); font-size: 17px; font-weight: 400; line-height: 28.8px; margin-top: 15px; text-align: center; padding-left: 15px; padding-right: 15px; padding-bottom: 15px;">
                                {{$item->content}}
                            </p>
